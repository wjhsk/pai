...
<div class="container" style=" text-align: center; margin-top:20px;">
  <div class="list-group">
    ...
    <li class="list-group-item active">
       <span style="font-size:20px;">职工信息</span> 
    </li>
    </ul>
  </div>   
  ...
  <div style="width:50%; margin-bottom:10px">
   <form action="/mypaidan/ManagerServlet?page=1&action=2" method="post">  
    	<div class="input-group md-3">
			  <div class="input-group-prepend ">
				 <span class="input-group-text">用户名</span>
			  </div>
			  <input  type="text" class="form-control" placeholder="请输入职工名" id="StaffNumber" name="StaffNumber"/>
			  &nbsp;&nbsp;
	...
	<c:forEach items="${userlist}" var="user"> 
     <tbody style=" text-align: center;">
      <tr>
	   ...
	   <td height="26px">
	   <form action="/mypaidan/ManagerServlet?page=1&action=2" method="post">
	       <input type="hidden" name="Staff" value="${user.uid }"> 
 ...
 <div class="container" style=" text-align: center; margin:0px auto;">
      ...
      <br>
       <ul class="pagination float-md-right">
          <li class="page-item"> 
             <a class="page-link" href="/mypaidan/ManagerServlet?page=1&action=2">首页</a>
          </li>
          <li class="page-item">
             <%--如果当前页面不是第一页，显示上一页选项 --%>
             <c:if test="${dopage.nowPage>1 }">
               <a class="page-link" href="/mypaidan/ManagerServlet?page=${dopage.nowPage-1 }&action=2">上一页</a>
             </c:if>
          </li>
          <li class="page-item"> 
             <%--如果当前页面不是最后一页，显示下一页选项 --%>
             <c:if test="${dopage.nowPage<dopage.totalPage}">
                <a class="page-link" href="/mypaidan/ManagerServlet?page=${dopage.nowPage+1 }&action=2">下一页</a>
             </c:if>
          </li>
          <li class="page-item">
            <%--显示末页 --%>
            
            <a class="page-link" href="/mypaidan/ManagerServlet?page=${dopage.totalPage }&action=2">末页</a>
          </li>
          <li class="page-item">
