  ...
  <div class="container" style=" text-align: center; margin:0px auto;">
      <br>
       <ul class="pagination float-md-right">
          <li class="page-item"> 
             <a class="page-link" href="/mypaidan/StaffServlet?page=1&action=1">首页</a>
          </li>
          <li class="page-item">
             <%--如果当前页面不是第一页，显示上一页选项 --%>
             <c:if test="${dopage.nowPage>1 }">
               <a class="page-link" href="/mypaidan/StaffServlet?page=${dopage.nowPage-1 }&action=1">上一页</a>
             </c:if>
          </li>
          <li class="page-item"> 
             <%--如果当前页面不是最后一页，显示下一页选项 --%>
             <c:if test="${dopage.nowPage<dopage.totalPage}">
                <a class="page-link" href="/mypaidan/StaffServlet?page=${dopage.nowPage+1 }&action=1">下一页</a>
             </c:if>
          </li>
          <li class="page-item">
            <%--显示末页 --%>
            <a class="page-link" href="/mypaidan/StaffServlet?page=${dopage.totalPage }&action=1&StaffNumber=${StaffNumber }">末页</a>
          </li>
          <li class="page-item">
