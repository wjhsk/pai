...
<div class="container" style=" text-align: center; margin-top:20px;">
  ...
  <div style="width:50%; margin-bottom:10px">
   <form action="/mypaidan/ShowServlet?page=1" method="post">  
 ...
 <div class="container" style=" text-align: center; margin:0px auto;">
      ...
      <br>
       <ul class="pagination float-md-right">
          <li class="page-item"> 
             <a class="page-link" href="/mypaidan/ShowServlet?page=1">首页</a>
          </li>
          <li class="page-item">
             <%--如果当前页面不是第一页，显示上一页选项 --%>
             <c:if test="${dopage.nowPage>1 }">
               <a class="page-link" href="/mypaidan/ShowServlet?page=${dopage.nowPage-1 }">上一页</a>
             </c:if>
          </li>
          <li class="page-item"> 
             <%--如果当前页面不是最后一页，显示下一页选项 --%>
             <c:if test="${dopage.nowPage<dopage.totalPage}">
                <a class="page-link" href="/mypaidan/ShowServlet?page=${dopage.nowPage+1 }">下一页</a>
             </c:if>
          </li>
          <li class="page-item">
            <%--显示末页 --%>
            <a class="page-link" href="/mypaidan/ShowServlet?page=${dopage.totalPage }">末页</a>
          </li>
          <li class="page-item">
